...
export const writeCharacteristic = (text) => {
  ...
  do{
   ...
   // let base64color = btoa(String.fromCharCode.apply(null, buffer));
    //state.BLEs.connectedDevice.writeCharacteristicWithResponseForService(state.BLEs.selectedService.uuid,state.BLEs.selectedCharacteristic.uuid, base64color)
  }
}
